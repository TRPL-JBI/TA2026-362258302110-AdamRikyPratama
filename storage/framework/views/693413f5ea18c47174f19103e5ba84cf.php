            ...
            <form id="formOrganisasi" action="<?php echo e(route('user.organisasi.store')); ?>" method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                       ...
                       value="<?php echo e(isset($organisasi->tanggal_berdiri) ? \Carbon\Carbon::parse($organisasi->tanggal_berdiri)->format('Y-m-d') : ''); ?>">
                    </div>
                </div>
...
<?php /**PATH D:\New Code\kik-fullstack\resources\views/user/organisasi/create.blade.php ENDPATH**/ ?>